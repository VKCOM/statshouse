...
func parseCommandLine() (err error) {
	...
	flag.IntVar(&argv.chV2MaxLightFastConns, "clickhouse-v2-max-conns", 50, "maximum number of ClickHouse-v2 connections (light fast)")
	flag.IntVar(&argv.chV2MaxLightSlowConns, "clickhouse-v2-max-light-slow-conns", 15, "maximum number of ClickHouse-v2 connections (light slow)")
	flag.IntVar(&argv.chV2MaxHeavyFastConns, "clickhouse-v2-max-heavy-conns", 6, "maximum number of ClickHouse-v2 connections (heavy fast)")
	...
	flag.IntVar(&argv.chV2MaxHardwareFastConns, "clickhouse-v2-max-hardware-fast-conns", 9, "maximum number of ClickHouse-v2 connections (hardware fast)")
	flag.IntVar(&argv.chV2MaxHardwareSlowConns, "clickhouse-v2-max-hardware-slow-conns", 5, "maximum number of ClickHouse-v2 connections (hardware slow)")
