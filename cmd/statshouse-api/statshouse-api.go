...
func main() {
	...
	pflag.IntVar(&argv.chV2MaxLightFastConns, "clickhouse-v2-max-conns", 48, "maximum number of ClickHouse-v2 connections (light fast)")
	pflag.IntVar(&argv.chV2MaxLightSlowConns, "clickhouse-v2-max-light-slow-conns", 24, "maximum number of ClickHouse-v2 connections (light slow)")
	pflag.IntVar(&argv.chV2MaxHeavyFastConns, "clickhouse-v2-max-heavy-conns", 10, "maximum number of ClickHouse-v2 connections (heavy fast)")
