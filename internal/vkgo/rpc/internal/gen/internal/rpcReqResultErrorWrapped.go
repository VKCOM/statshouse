...
func (item *RpcReqResultErrorWrapped) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *RpcReqResultErrorWrapped) WriteTL1General(w []byte) (_ []byte, err error) {
...
func (item *RpcReqResultErrorWrapped) WriteTL1(w []byte) []byte {
...
func (item *RpcReqResultErrorWrapped) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *RpcReqResultErrorWrapped) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
...
func (item *RpcReqResultErrorWrapped) WriteTL1Boxed(w []byte) []byte {
...
func (item *RpcReqResultErrorWrapped) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *RpcReqResultErrorWrapped) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *RpcReqResultErrorWrapped) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
