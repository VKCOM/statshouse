...
func (item *DictFieldStringLong) Read(w []byte) (_ []byte, err error) {
...
func (item *DictFieldStringLong) WriteGeneral(w []byte) (_ []byte, err error) {
...
func (item *DictFieldStringLong) Write(w []byte) []byte {
