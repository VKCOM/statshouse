...
func (item *RpcPong) ReadTL1(w []byte) (_ []byte, err error) {
	return basictl.LongRead(w, &item.PingId)
}

func (item *RpcPong) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *RpcPong) WriteTL1(w []byte) []byte {
	w = basictl.LongWrite(w, item.PingId)
	return w
}

func (item *RpcPong) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *RpcPong) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *RpcPong) WriteTL1Boxed(w []byte) []byte {
