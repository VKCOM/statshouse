...
func (item *NetUdpPacketEncHeader) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	var propSingleRpcMsgPresented bool
	var trueTypeSingleRpcMsgValue bool
	var propMultipleRpcMsgsPresented bool
	var trueTypeMultipleRpcMsgsValue bool
	var propZeroPadding1BytePresented bool
	var trueTypeZeroPadding1ByteValue bool
	var propZeroPadding2BytesPresented bool
	var trueTypeZeroPadding2BytesValue bool
	var propZeroPadding4BytesPresented bool
	var trueTypeZeroPadding4BytesValue bool
	var propZeroPadding8BytesPresented bool
	...
	if propSingleRpcMsgPresented && !trueTypeSingleRpcMsgValue && (item.Flags&(1<<26) != 0) {
		return ErrorInvalidJSON("netUdpPacket.encHeader", "field 'single_rpc_msg' is explicitly set to false, but corresponding fieldmask item.Flags bit 26 is 1")
	}
	if propMultipleRpcMsgsPresented && !trueTypeMultipleRpcMsgsValue && (item.Flags&(1<<27) != 0) {
		return ErrorInvalidJSON("netUdpPacket.encHeader", "field 'multiple_rpc_msgs' is explicitly set to false, but corresponding fieldmask item.Flags bit 27 is 1")
	}
	if propZeroPadding1BytePresented && !trueTypeZeroPadding1ByteValue && (item.Flags&(1<<18) != 0) {
		return ErrorInvalidJSON("netUdpPacket.encHeader", "field 'zero_padding_1_byte' is explicitly set to false, but corresponding fieldmask item.Flags bit 18 is 1")
	}
	if propZeroPadding2BytesPresented && !trueTypeZeroPadding2BytesValue && (item.Flags&(1<<19) != 0) {
		return ErrorInvalidJSON("netUdpPacket.encHeader", "field 'zero_padding_2_bytes' is explicitly set to false, but corresponding fieldmask item.Flags bit 19 is 1")
	}
	if propZeroPadding4BytesPresented && !trueTypeZeroPadding4BytesValue && (item.Flags&(1<<28) != 0) {
		return ErrorInvalidJSON("netUdpPacket.encHeader", "field 'zero_padding_4_bytes' is explicitly set to false, but corresponding fieldmask item.Flags bit 28 is 1")
	}
	if propZeroPadding8BytesPresented && !trueTypeZeroPadding8BytesValue && (item.Flags&(1<<29) != 0) {
		return ErrorInvalidJSON("netUdpPacket.encHeader", "field 'zero_padding_8_bytes' is explicitly set to false, but corresponding fieldmask item.Flags bit 29 is 1")
	}
	return nil
}
