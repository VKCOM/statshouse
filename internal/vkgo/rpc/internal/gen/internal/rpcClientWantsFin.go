...
func (item *RpcClientWantsFin) Read(w []byte) (_ []byte, err error) {
	return item.ReadTL1(w)
}
func (item *RpcClientWantsFin) ReadTL1(w []byte) (_ []byte, err error) { return w, nil }

func (item *RpcClientWantsFin) WriteGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1General(w)
}
func (item *RpcClientWantsFin) WriteTL1General(w []byte) (_ []byte, err error) {
...
func (item *RpcClientWantsFin) WriteTL1(w []byte) []byte {
	return w
}
...
func (item *RpcClientWantsFin) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *RpcClientWantsFin) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
...
func (item *RpcClientWantsFin) WriteTL1Boxed(w []byte) []byte {
...
func (item *RpcClientWantsFin) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	if in != nil {
		in.Delim('{')
		if !in.Ok() {
			return in.Error()
...
func (item *RpcClientWantsFin) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *RpcClientWantsFin) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	return append(w, '}')
}
