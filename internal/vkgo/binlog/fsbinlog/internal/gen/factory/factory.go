...
import (
	...
	"github.com/VKCOM/statshouse/internal/vkgo/binlog/fsbinlog/internal/gen/meta" // force import to call meta init first
)
...
func init() {
	metainternal.SetGlobalFactoryCreateForObject("fsbinlog.levStart", func() metainternal.Object { return new(internal.FsbinlogLevStart) })
	metainternal.SetGlobalFactoryCreateForObject("fsbinlog.levUpgradeToGms", func() metainternal.Object { return new(internal.FsbinlogLevUpgradeToGms) })
	metainternal.SetGlobalFactoryCreateForObject("fsbinlog.snapshotMeta", func() metainternal.Object { return new(internal.FsbinlogSnapshotMeta) })
}
