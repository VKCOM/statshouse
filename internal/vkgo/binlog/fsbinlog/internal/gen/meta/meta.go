...
func init() {
	fillObject(&TLItem{tlName: "fsbinlog.levStart", tag: 0x044c644b, hasTL1: true})
	fillObject(&TLItem{tlName: "fsbinlog.levUpgradeToGms", tag: 0xb75009a0, hasTL1: true})
	fillObject(&TLItem{tlName: "fsbinlog.snapshotMeta", tag: 0x6b49d850, hasTL1: true})
}
