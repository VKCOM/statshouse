...
func (item *BarsicEngineWantsRestart) ReadResultJSON(legacyTypeNames bool, j interface{}, ret *tlTrue.True) error {
...
func (item *BarsicEngineWantsRestart) ReadJSONLegacy(legacyTypeNames bool, j interface{}) error {
