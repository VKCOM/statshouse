...
type (
	ChunkResponse         = internal.StatshouseApiChunkResponse
	...
	QueryPointResponse    = internal.StatshouseApiQueryPointResponse
	QueryResponse         = internal.StatshouseApiQueryResponse
...
func (c *Client) GetChunk(ctx context.Context, args GetChunk, extra *rpc.InvokeReqExtra, ret *ChunkResponse) (err error) {
...
func (c *Client) GetQuery(ctx context.Context, args GetQuery, extra *rpc.InvokeReqExtra, ret *QueryResponse) (err error) {
	req := c.Client.GetRequest()
	req.ActorID = c.ActorID
...
func (c *Client) GetQueryPoint(ctx context.Context, args GetQueryPoint, extra *rpc.InvokeReqExtra, ret *QueryPointResponse) (err error) {
	req := c.Client.GetRequest()
	req.ActorID = c.ActorID
	req.ReadOnly = true
...
type Handler struct {
	GetChunk      func(ctx context.Context, args GetChunk) (ChunkResponse, error)              // statshouseApi.getChunk
	GetMapping    func(ctx context.Context, args GetMapping) (GetMappingResponse, error)       // statshouseApi.getMapping
	GetQuery      func(ctx context.Context, args GetQuery) (QueryResponse, error)              // statshouseApi.getQuery
	GetQueryPoint func(ctx context.Context, args GetQueryPoint) (QueryPointResponse, error)    // statshouseApi.getQueryPoint
