...
const (
	...
	StatshouseSendKeepAlive                                = 0x3285ff53 // statshouse.sendKeepAlive
	StatshouseSendKeepAlive2                               = 0x4285ff53 // statshouse.sendKeepAlive2
	StatshouseSendSourceBucket                             = 0x94575940 // statshouse.sendSourceBucket
	StatshouseSendSourceBucket2                            = 0x44575940 // statshouse.sendSourceBucket2
	StatshouseSourceBucket                                 = 0x3af6c822 // statshouse.sourceBucket
	StatshouseSourceBucket2                                = 0x3af6e822 // statshouse.sourceBucket2
	StatshouseStringTopElement                             = 0xec2e097d // statshouse.string_top_element
	StatshouseTestConnection                               = 0x3285ff58 // statshouse.testConnection
	...
	StatshouseMetadataCreateEntityEvent                    = 0x1a345674 // statshouse_metadata.createEntityEvent
	StatshouseMetadataCreateMappingEvent                   = 0x12345678 // statshouse_metadata.createMappingEvent
	StatshouseMetadataCreateMetricEvent                    = 0x12345674 // statshouse_metadata.createMetricEvent
	StatshouseMetadataEditEntityEvent                      = 0x1234b677 // statshouse_metadata.editEntityEvent
	StatshouseMetadataEditEntitynew                        = 0x86df475f // statshouse_metadata.editEntitynew
	StatshouseMetadataEditMetricEvent                      = 0x12345677 // statshouse_metadata.editMetricEvent
	StatshouseMetadataEvent                                = 0x9286affa // statshouse_metadata.event
	StatshouseMetadataGetInvertMapping                     = 0x9faf5280 // statshouse_metadata.getInvertMapping
	StatshouseMetadataGetInvertMappingResponse             = 0x9286abac // statshouse_metadata.getInvertMappingResponse
	StatshouseMetadataGetInvertMappingResponseKeyNotExists = 0x9286abab // statshouse_metadata.getInvertMappingResponseKeyNotExists
	StatshouseMetadataGetJournalResponsenew                = 0x9286aaaa // statshouse_metadata.getJournalResponsenew
	StatshouseMetadataGetJournalnew                        = 0x93ba92f8 // statshouse_metadata.getJournalnew
	StatshouseMetadataGetMapping                           = 0x9dfa7a83 // statshouse_metadata.getMapping
	StatshouseMetadataGetMappingResponse                   = 0x9286abfc // statshouse_metadata.getMappingResponse
	StatshouseMetadataGetMappingResponseCreated            = 0x9286abbb // statshouse_metadata.getMappingResponseCreated
	StatshouseMetadataGetMappingResponseFloodLimitError    = 0x9286abfd // statshouse_metadata.getMappingResponseFloodLimitError
	StatshouseMetadataGetMappingResponseKeyNotExists       = 0x9286abff // statshouse_metadata.getMappingResponseKeyNotExists
	StatshouseMetadataGetMetrics                           = 0x93ba92f5 // statshouse_metadata.getMetrics
	StatshouseMetadataGetMetricsResponse                   = 0x9286abfb // statshouse_metadata.getMetricsResponse
	StatshouseMetadataGetTagMappingBootstrap               = 0x5fc81a9b // statshouse_metadata.getTagMappingBootstrap
	StatshouseMetadataMetricOld                            = 0x9286abfa // statshouse_metadata.metricOld
	StatshouseMetadataPutBootstrapEvent                    = 0x5854dfaf // statshouse_metadata.putBootstrapEvent
	StatshouseMetadataPutMapping                           = 0x9faf5281 // statshouse_metadata.putMapping
	StatshouseMetadataPutMappingEvent                      = 0x12345676 // statshouse_metadata.putMappingEvent
	StatshouseMetadataPutMappingResponse                   = 0x9286abfe // statshouse_metadata.putMappingResponse
	StatshouseMetadataPutTagMappingBootstrap               = 0x5fc8ab9b // statshouse_metadata.putTagMappingBootstrap
	StatshouseMetadataResetFlood                           = 0x9faf5282 // statshouse_metadata.resetFlood
	StatshouseMetadataResetFlood2                          = 0x88d0fd5e // statshouse_metadata.resetFlood2
	StatshouseMetadataResetFloodResponse                   = 0x9286abee // statshouse_metadata.resetFloodResponse
	StatshouseMetadataResetFloodResponse2                  = 0x9286abef // statshouse_metadata.resetFloodResponse2
