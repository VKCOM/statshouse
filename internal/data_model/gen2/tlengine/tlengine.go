...
type (
	...
	DictFieldStringMetafilesStatDataBoxed = internal.DictFieldStringEngineMetafilesStatDataBoxed
	DictionaryMetafilesStatDataBoxed      = internal.DictionaryEngineMetafilesStatDataBoxed
	...
	MetafilesStatData                     = internal.EngineMetafilesStatData
	Mode                                  = internal.EngineMode
	...
	GetExpectedMetafilesStats__Result  = map[string]internal.EngineMetafilesStatData
...
func (c *Client) GetReadWriteMode(ctx context.Context, args GetReadWriteMode, extra *rpc.InvokeReqExtra, ret *Mode) (err error) {
	req := c.Client.GetRequest()
	req.ActorID = c.ActorID
...
type Handler struct {
	...
	GetReadWriteMode          func(ctx context.Context, args GetReadWriteMode) (Mode, error)                                       // engine.getReadWriteMode
