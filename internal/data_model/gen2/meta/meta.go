...
func init() {
	...
	fillFunction("metadata.getMappingsNew#93ba92f7", "#93ba92f7", &TLItem{tag: 0x93ba92f7, annotations: 0x4, tlName: "metadata.getMappingsNew", resultTypeContainsUnionTypes: false, argumentsTypesContainUnionTypes: false})
