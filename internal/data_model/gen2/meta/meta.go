...
func init() {
	...
	fillFunction("kv_engine.backup#3c7231b2", "#3c7231b2", &TLItem{tag: 0x3c7231b2, annotations: 0x8, tlName: "kv_engine.backup"})
	fillObject("kv_engine.backup_response#732a1764", "#732a1764", &TLItem{tag: 0x732a1764, annotations: 0x0, tlName: "kv_engine.backup_response"})
	fillObject("kv_engine.change_response#73eaa764", "#73eaa764", &TLItem{tag: 0x73eaa764, annotations: 0x0, tlName: "kv_engine.change_response"})
	fillFunction("kv_engine.check#2c3239ba", "#2c3239ba", &TLItem{tag: 0x2c3239ba, annotations: 0x8, tlName: "kv_engine.check"})
	fillFunction("kv_engine.get#1c7349bb", "#1c7349bb", &TLItem{tag: 0x1c7349bb, annotations: 0x4, tlName: "kv_engine.get"})
	fillObject("kv_engine.get_response#63eeb764", "#63eeb764", &TLItem{tag: 0x63eeb764, annotations: 0x0, tlName: "kv_engine.get_response"})
	fillFunction("kv_engine.healthcheck#2c1259aa", "#2c1259aa", &TLItem{tag: 0x2c1259aa, annotations: 0x4, tlName: "kv_engine.healthcheck"})
	fillFunction("kv_engine.inc#3c7239bb", "#3c7239bb", &TLItem{tag: 0x3c7239bb, annotations: 0x8, tlName: "kv_engine.inc"})
	fillObject("kv_engine.kv#18f34950", "#18f34950", &TLItem{tag: 0x18f34950, annotations: 0x0, tlName: "kv_engine.kv"})
	fillObject("kv_engine.meta_info#53eeb763", "#53eeb763", &TLItem{tag: 0x53eeb763, annotations: 0x0, tlName: "kv_engine.meta_info"})
	fillFunction("kv_engine.put#2c7349ba", "#2c7349ba", &TLItem{tag: 0x2c7349ba, annotations: 0x8, tlName: "kv_engine.put"})
