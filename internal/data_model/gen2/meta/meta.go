...
func init() {
	...
	fillFunction("statshouse.sendSourceBucket3#0d04aa3f", "#0d04aa3f", &TLItem{tag: 0x0d04aa3f, annotations: 0x8, tlName: "statshouse.sendSourceBucket3"})
	fillObject("statshouse.sendSourceBucket3Response#0e177acc", "#0e177acc", &TLItem{tag: 0x0e177acc, annotations: 0x0, tlName: "statshouse.sendSourceBucket3Response"})
	...
	fillObject("statshouse.sourceBucket3#16c4dd7b", "#16c4dd7b", &TLItem{tag: 0x16c4dd7b, annotations: 0x0, tlName: "statshouse.sourceBucket3"})
