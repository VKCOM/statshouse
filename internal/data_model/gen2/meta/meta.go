...
func init() {
	...
	fillFunction("metadata.getNewMappings#93ba92f7", "#93ba92f7", &TLItem{tag: 0x93ba92f7, annotations: 0x4, tlName: "metadata.getNewMappings", resultTypeContainsUnionTypes: true, argumentsTypesContainUnionTypes: false})
