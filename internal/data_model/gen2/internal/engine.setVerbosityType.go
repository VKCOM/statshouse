...
func (item *EngineSetVerbosityType) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *EngineSetVerbosityType) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *EngineSetVerbosityType) WriteTL1(w []byte) []byte {
	w = basictl.StringWrite(w, item.Type)
	w = basictl.IntWrite(w, item.Verbosity)
	return w
}

func (item *EngineSetVerbosityType) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *EngineSetVerbosityType) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *EngineSetVerbosityType) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x5388c0ae)
	return item.WriteTL1(w)
}

func (item *EngineSetVerbosityType) ReadResultTL1(w []byte, ret *True) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *EngineSetVerbosityType) WriteResultTL1(w []byte, ret True) (_ []byte, err error) {
...
func (item *EngineSetVerbosityType) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret True
	ret.FillRandom(rg)
...
func (item *EngineSetVerbosityType) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.setVerbosityType")
}

func (item *EngineSetVerbosityType) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.setVerbosityType")
}
