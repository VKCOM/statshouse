...
func (item *StatshouseApiFlag) ReadTL1(w []byte) (_ []byte, err error) {
	return item.ReadTL1Boxed(w)
}

func (item *StatshouseApiFlag) ReadTL1Boxed(w []byte) (_ []byte, err error) {
	var tag uint32
...
func (item *StatshouseApiFlag) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1BoxedGeneral(w)
}

func (item *StatshouseApiFlag) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseApiFlag) WriteTL1Boxed(w []byte) []byte {
...
func (item *StatshouseApiFlag) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	case "Auto", "statshouseApi.flagAuto#2a6e4c14", "statshouseApi.flagAuto", "#2a6e4c14":
		...
		item.index = 2
	default:
		return ErrorInvalidUnionTagJSON("statshouseApi.Flag", _tag)
	}
	return nil
}
