...
func (item *MetadataGetNewMappingsResponse) ReadTL1(w []byte, nat_field_mask uint32) (_ []byte, err error) {
	...
	return BuiltinVectorStatshouseMappingReadTL1(w, &item.Pairs)
}

func (item *MetadataGetNewMappingsResponse) WriteTL1(w []byte, nat_field_mask uint32) []byte {
	w = basictl.IntWrite(w, item.CurrentVersion)
	w = basictl.IntWrite(w, item.LastVersion)
	w = BuiltinVectorStatshouseMappingWriteTL1(w, item.Pairs)
	return w
}

func (item *MetadataGetNewMappingsResponse) ReadTL1Boxed(w []byte, nat_field_mask uint32) (_ []byte, err error) {
...
func (item *MetadataGetNewMappingsResponse) WriteTL1Boxed(w []byte, nat_field_mask uint32) []byte {
