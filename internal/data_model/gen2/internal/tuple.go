...
func BuiltinVectorTupleDouble2ReadTL1(w []byte, vec *[][2]float64) (_ []byte, err error) {
	var l uint32
	...
	for i := range *vec {
		if w, err = BuiltinTuple2DoubleReadTL1(w, &(*vec)[i]); err != nil {
			return w, err
		}
	}
	return w, nil
...
func BuiltinVectorTupleDouble2WriteTL1(w []byte, vec [][2]float64) []byte {
	w = basictl.NatWrite(w, uint32(len(vec)))
	for _, elem := range vec {
		w = BuiltinTuple2DoubleWriteTL1(w, &elem)
	}
	return w
}
...
func (item *TupleDouble2) ptr() *[2]float64 { return (*[2]float64)(item) }

func (TupleDouble2) TLName() string { return "tuple" }
func (TupleDouble2) TLTag() uint32  { return 0x9770768a }

func (item *TupleDouble2) Reset() {
	BuiltinTuple2DoubleReset(item.ptr())
}

func (item *TupleDouble2) FillRandom(rg *basictl.RandGenerator) {
	BuiltinTuple2DoubleFillRandom(rg, item.ptr())
}

func (item *TupleDouble2) ReadTL1(w []byte) (_ []byte, err error) {
	return BuiltinTuple2DoubleReadTL1(w, item.ptr())
}

func (item *TupleDouble2) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *TupleDouble2) WriteTL1(w []byte) []byte {
	w = BuiltinTuple2DoubleWriteTL1(w, item.ptr())
	return w
}

func (item *TupleDouble2) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *TupleDouble2) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *TupleDouble2) WriteTL1Boxed(w []byte) []byte {
