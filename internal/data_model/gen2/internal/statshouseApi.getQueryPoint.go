...
func (item StatshouseApiGetQueryPoint) RepairMasksValue() StatshouseApiGetQueryPoint {
	item.RepairMasks()
	return item
}
func (item *StatshouseApiGetQueryPoint) RepairMasks() {
	item.Query.RepairMasks()
}

func (item *StatshouseApiGetQueryPoint) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiGetQueryPoint) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseApiGetQueryPoint) WriteTL1(w []byte) []byte {
...
func (item *StatshouseApiGetQueryPoint) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiGetQueryPoint) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseApiGetQueryPoint) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x0c7348bb)
	return item.WriteTL1(w)
}

func (item *StatshouseApiGetQueryPoint) ReadResultTL1(w []byte, ret *StatshouseApiQueryPointResponse) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *StatshouseApiGetQueryPoint) WriteResultTL1(w []byte, ret StatshouseApiQueryPointResponse) (_ []byte, err error) {
...
func (item *StatshouseApiGetQueryPoint) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret StatshouseApiQueryPointResponse) ([]int, int) {
	sizes = append(sizes, 2450459293)
...
func (item *StatshouseApiGetQueryPoint) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret StatshouseApiQueryPointResponse) ([]byte, []int, int) {
	if sizes[0] != 2450459293 {
...
func (item *StatshouseApiGetQueryPoint) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
...
func (item *StatshouseApiGetQueryPoint) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiQueryPointResponse
	if r, err = item.ReadResultTL1(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *StatshouseApiGetQueryPoint) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiQueryPointResponse
...
func (item *StatshouseApiGetQueryPoint) ReadResultTL2WriteResultJSON(tctx *basictl.TL2ReadContext, jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiQueryPointResponse
	if r, err = item.ReadResultTL2(r, tctx, &ret); err != nil {
		return r, w, err
	}
