...
type StatshouseGetTargets2 struct {
	...
	// in contrast to normalized and validated for statshouse key, like in header
	PromHostName         string
	OldHash              string
...
func (item *StatshouseGetTargets2) ReadTL1(w []byte) (_ []byte, err error) {
	...
	if item.FieldsMask&(1<<0) != 0 {
		if w, err = BoolReadTL1Boxed(w, &item.GaugeMetrics); err != nil {
			return w, err
		}
	} else {
		item.GaugeMetrics = false
	...
	if item.FieldsMask&(1<<1) != 0 {
		if w, err = BoolReadTL1Boxed(w, &item.MetricRelabelConfigs); err != nil {
			return w, err
		}
	} else {
		item.MetricRelabelConfigs = false
...
func (item *StatshouseGetTargets2) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseGetTargets2) WriteTL1(w []byte) []byte {
	...
	if item.FieldsMask&(1<<0) != 0 {
		w = BoolWriteTL1Boxed(w, item.GaugeMetrics)
	}
	if item.FieldsMask&(1<<1) != 0 {
		w = BoolWriteTL1Boxed(w, item.MetricRelabelConfigs)
	}
	return w
}

func (item *StatshouseGetTargets2) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseGetTargets2) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseGetTargets2) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x41df72a3)
	return item.WriteTL1(w)
}

func (item *StatshouseGetTargets2) ReadResultTL1(w []byte, ret *StatshouseGetTargetsResult) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w, item.FieldsMask)
}

func (item *StatshouseGetTargets2) WriteResultTL1(w []byte, ret StatshouseGetTargetsResult) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w, item.FieldsMask)
	return w, nil
}

func (item *StatshouseGetTargets2) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *StatshouseGetTargetsResult) error {
...
func (item *StatshouseGetTargets2) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret StatshouseGetTargetsResult) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w, item.FieldsMask)
	return w, nil
}

func (item *StatshouseGetTargets2) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret StatshouseGetTargetsResult
	ret.FillRandom(rg, item.FieldsMask)
	return item.WriteResultTL1(w, ret)
}

func (item *StatshouseGetTargets2) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseGetTargetsResult
...
func (item *StatshouseGetTargets2) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseGetTargetsResult
...
func (item *StatshouseGetTargets2) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

func (item *StatshouseGetTargets2) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

func (item *StatshouseGetTargets2) ReadResultTL2WriteResultJSON(tctx *basictl.TL2ReadContext, jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

func (item *StatshouseGetTargets2) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}
...
// Set field "metric_relabel_configs" in "statshouse.promTarget" by changing fieldMask "fields_mask"
func (item *StatshouseGetTargets2) SetStatshousePromTargetMetricRelabelConfigs(value bool) {
	if value {
		item.FieldsMask |= 1 << 1
	} else {
		item.FieldsMask &^= 1 << 1
...
func (item *StatshouseGetTargets2) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *StatshouseGetTargets2) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *StatshouseGetTargets2) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *StatshouseGetTargets2) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	panic(ErrorTL2SerializersNotGenerated("statshouse.getTargets2"))
}

func (item *StatshouseGetTargets2) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
...
func (item *StatshouseGetTargets2Bytes) ReadTL1(w []byte) (_ []byte, err error) {
	if w, err = basictl.NatRead(w, &item.FieldsMask); err != nil {
		return w, err
	}
	if w, err = item.Header.ReadTL1(w, item.FieldsMask); err != nil {
...
func (item *StatshouseGetTargets2Bytes) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseGetTargets2Bytes) WriteTL1(w []byte) []byte {
	w = basictl.NatWrite(w, item.FieldsMask)
	w = item.Header.WriteTL1(w, item.FieldsMask)
...
func (item *StatshouseGetTargets2Bytes) ReadTL1Boxed(w []byte) (_ []byte, err error) {
	if w, err = basictl.NatReadExactTag(w, 0x41df72a3); err != nil {
		return w, err
	}
	return item.ReadTL1(w)
...
func (item *StatshouseGetTargets2Bytes) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseGetTargets2Bytes) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x41df72a3)
	return item.WriteTL1(w)
}

func (item *StatshouseGetTargets2Bytes) ReadResultTL1(w []byte, ret *StatshouseGetTargetsResultBytes) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w, item.FieldsMask)
}

func (item *StatshouseGetTargets2Bytes) WriteResultTL1(w []byte, ret StatshouseGetTargetsResultBytes) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w, item.FieldsMask)
	return w, nil
}

func (item *StatshouseGetTargets2Bytes) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *StatshouseGetTargetsResultBytes) error {
	if err := ret.ReadJSONGeneral(jctx, in, item.FieldsMask); err != nil {
		return err
	}
	return nil
...
func (item *StatshouseGetTargets2Bytes) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret StatshouseGetTargetsResultBytes) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w, item.FieldsMask)
	return w, nil
}

func (item *StatshouseGetTargets2Bytes) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret StatshouseGetTargetsResultBytes
	ret.FillRandom(rg, item.FieldsMask)
	return item.WriteResultTL1(w, ret)
}

func (item *StatshouseGetTargets2Bytes) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseGetTargetsResultBytes
	if r, err = item.ReadResultTL1(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *StatshouseGetTargets2Bytes) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseGetTargetsResultBytes
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *StatshouseGetTargets2Bytes) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

func (item *StatshouseGetTargets2Bytes) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

func (item *StatshouseGetTargets2Bytes) ReadResultTL2WriteResultJSON(tctx *basictl.TL2ReadContext, jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

func (item *StatshouseGetTargets2Bytes) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}

// Set field "gauge_metrics" in "statshouse.getTargetsResult" by changing fieldMask "fields_mask"
func (item *StatshouseGetTargets2Bytes) SetStatshouseGetTargetsResultGaugeMetrics(value bool) {
	if value {
		item.FieldsMask |= 1 << 0
	} else {
		item.FieldsMask &^= 1 << 0
...
// Set field "metric_relabel_configs" in "statshouse.promTarget" by changing fieldMask "fields_mask"
func (item *StatshouseGetTargets2Bytes) SetStatshousePromTargetMetricRelabelConfigs(value bool) {
	if value {
		item.FieldsMask |= 1 << 1
	} else {
		item.FieldsMask &^= 1 << 1
...
func (item *StatshouseGetTargets2Bytes) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	var propFieldsMaskPresented bool
	var propHeaderPresented bool
	var rawHeader []byte
	var propPromHostNamePresented bool
...
// This method is general version of WriteJSON, use it instead!
func (item *StatshouseGetTargets2Bytes) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
	return item.WriteJSONOpt(jctx, w), nil
}
...
func (item *StatshouseGetTargets2Bytes) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	backupIndexFieldsMask := len(w)
	w = basictl.JSONAddCommaIfNeeded(w)
	w = append(w, `"fields_mask":`...)
...
func (item *StatshouseGetTargets2Bytes) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	panic(ErrorTL2SerializersNotGenerated("statshouse.getTargets2"))
}

func (item *StatshouseGetTargets2Bytes) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	return r, ErrorTL2SerializersNotGenerated("statshouse.getTargets2")
}
