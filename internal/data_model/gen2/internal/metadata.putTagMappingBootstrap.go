...
func (item *MetadataPutTagMappingBootstrap) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshousePutTagMappingBootstrapResult
...
func (item *MetadataPutTagMappingBootstrap) ReadResultWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("metadata.putTagMappingBootstrap")
}

func (item *MetadataPutTagMappingBootstrap) ReadResultTL2WriteResult(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("metadata.putTagMappingBootstrap")
}
