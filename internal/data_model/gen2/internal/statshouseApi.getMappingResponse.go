...
func (item StatshouseApiGetMappingResponse) RepairMasksValue(nat_fields_mask uint32) StatshouseApiGetMappingResponse {
	item.RepairMasks(nat_fields_mask)
	return item
}
func (item *StatshouseApiGetMappingResponse) RepairMasks(nat_fields_mask uint32) {
	item.tl2mask0 = 0
	if nat_fields_mask&(1<<3) != 0 {
		item.tl2mask0 |= 1
	}
...
func (item *StatshouseApiGetMappingResponse) ReadTL1(w []byte, nat_fields_mask uint32) (_ []byte, err error) {
	item.tl2mask0 = 0
	if nat_fields_mask&(1<<3) != 0 {
		item.tl2mask0 |= 1
...
func (item *StatshouseApiGetMappingResponse) WriteTL1(w []byte, nat_fields_mask uint32) []byte {
	if nat_fields_mask&(1<<3) != 0 {
...
func (item *StatshouseApiGetMappingResponse) ReadTL1Boxed(w []byte, nat_fields_mask uint32) (_ []byte, err error) {
...
func (item *StatshouseApiGetMappingResponse) WriteTL1Boxed(w []byte, nat_fields_mask uint32) []byte {
...
func (item *StatshouseApiGetMappingResponse) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer, nat_fields_mask uint32) error {
	...
	if !propIntValuePresented && nat_fields_mask&(1<<3) != 0 {
		item.tl2mask0 |= 1
	}
	if !propStringValuePresented && nat_fields_mask&(1<<4) != 0 {
		item.tl2mask0 |= 2
	}
	if propIntValuePresented {
	}
