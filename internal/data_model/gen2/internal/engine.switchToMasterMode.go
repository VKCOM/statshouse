...
func (item *EngineSwitchToMasterMode) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret EngineSwitchMasterReplicaModeResult
...
func (item *EngineSwitchToMasterMode) ReadResultWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.switchToMasterMode")
}

func (item *EngineSwitchToMasterMode) ReadResultTL2WriteResult(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.switchToMasterMode")
}
