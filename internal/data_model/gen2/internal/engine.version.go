...
func (item *EngineVersion) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *string) error {
...
func (item *EngineVersion) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret string) (_ []byte, err error) {
...
func (item *EngineVersion) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret string
...
func (item *EngineVersion) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret string
...
func (item *EngineVersion) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.version")
}
...
func (item *EngineVersion) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	if in != nil {
		in.Delim('{')
		if !in.Ok() {
			return in.Error()
...
func (item *EngineVersion) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *EngineVersion) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	return append(w, '}')
}
...
func (item *EngineVersion) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	panic(ErrorTL2SerializersNotGenerated("engine.version"))
}

func (item *EngineVersion) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
