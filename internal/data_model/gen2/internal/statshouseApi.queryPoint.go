...
func (item StatshouseApiQueryPoint) RepairMasksValue() StatshouseApiQueryPoint {
	item.RepairMasks()
	return item
}
func (item *StatshouseApiQueryPoint) RepairMasks() {
	item.tl2mask0 = 0
	if item.FieldsMask&(1<<1) != 0 {
		item.tl2mask0 |= 1
	}
...
func (item *StatshouseApiQueryPoint) ReadTL1(w []byte) (_ []byte, err error) {
	item.tl2mask0 = 0
...
func (item *StatshouseApiQueryPoint) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseApiQueryPoint) WriteTL1(w []byte) []byte {
...
func (item *StatshouseApiQueryPoint) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiQueryPoint) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseApiQueryPoint) WriteTL1Boxed(w []byte) []byte {
...
func (item *StatshouseApiQueryPoint) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	item.tl2mask0 = 0
...
func (item *StatshouseApiQueryPoint) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiQueryPoint) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *StatshouseApiQueryPoint) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *StatshouseApiQueryPoint) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
