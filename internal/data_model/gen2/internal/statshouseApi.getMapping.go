...
func (item StatshouseApiGetMapping) RepairMasksValue() StatshouseApiGetMapping {
	item.RepairMasks()
	return item
}
func (item *StatshouseApiGetMapping) RepairMasks() {
	item.tl2mask0 = 0
	if item.FieldsMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
	}
...
func (item *StatshouseApiGetMapping) ReadTL1(w []byte) (_ []byte, err error) {
	item.tl2mask0 = 0
...
func (item *StatshouseApiGetMapping) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseApiGetMapping) WriteTL1(w []byte) []byte {
...
func (item *StatshouseApiGetMapping) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiGetMapping) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseApiGetMapping) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x4239a8f8)
	return item.WriteTL1(w)
}

func (item *StatshouseApiGetMapping) ReadResultTL1(w []byte, ret *StatshouseApiGetMappingResponse) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w, item.FieldsMask)
}

func (item *StatshouseApiGetMapping) WriteResultTL1(w []byte, ret StatshouseApiGetMappingResponse) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w, item.FieldsMask)
	return w, nil
}

func (item *StatshouseApiGetMapping) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *StatshouseApiGetMappingResponse) (_ []byte, err error) {
	currentSize := 0
...
func (item *StatshouseApiGetMapping) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret StatshouseApiGetMappingResponse) []byte {
...
func (item *StatshouseApiGetMapping) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *StatshouseApiGetMappingResponse) error {
...
func (item *StatshouseApiGetMapping) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret StatshouseApiGetMappingResponse) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w, item.FieldsMask)
	return w, nil
}

func (item *StatshouseApiGetMapping) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret StatshouseApiGetMappingResponse
	ret.FillRandom(rg, item.FieldsMask)
	return item.WriteResultTL1(w, ret)
}

func (item *StatshouseApiGetMapping) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiGetMappingResponse
...
func (item *StatshouseApiGetMapping) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiGetMappingResponse
...
func (item *StatshouseApiGetMapping) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiGetMappingResponse
	if r, err = item.ReadResultTL1(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *StatshouseApiGetMapping) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiGetMappingResponse
...
func (item *StatshouseApiGetMapping) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret StatshouseApiGetMappingResponse
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *StatshouseApiGetMapping) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	item.tl2mask0 = 0
	...
	if !propIntValuePresented && item.FieldsMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
	}
	if !propStringValuePresented && item.FieldsMask&(1<<1) != 0 {
		item.tl2mask0 |= 2
	}
	if propIntValuePresented {
		item.FieldsMask |= 1 << 0
...
func (item *StatshouseApiGetMapping) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiGetMapping) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *StatshouseApiGetMapping) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *StatshouseApiGetMapping) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
