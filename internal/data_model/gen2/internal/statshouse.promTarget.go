...
func BuiltinVectorStatshousePromTargetReadTL1(w []byte, vec *[]StatshousePromTarget, nat_t uint32) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorStatshousePromTargetWriteTL1(w []byte, vec []StatshousePromTarget, nat_t uint32) []byte {
...
func BuiltinVectorStatshousePromTargetBytesReadTL1(w []byte, vec *[]StatshousePromTargetBytes, nat_t uint32) (_ []byte, err error) {
	var l uint32
	if w, err = basictl.NatRead(w, &l); err != nil {
		return w, err
	}
...
func BuiltinVectorStatshousePromTargetBytesWriteTL1(w []byte, vec []StatshousePromTargetBytes, nat_t uint32) []byte {
	w = basictl.NatWrite(w, uint32(len(vec)))
	for _, elem := range vec {
		w = elem.WriteTL1(w, nat_t)
	}
...
func (item *StatshousePromTarget) Reset() {
	...
	item.JobName = ""
	item.Url = ""
	BuiltinDictStringStringReset(item.Labels)
...
func (item *StatshousePromTarget) FillRandom(rg *basictl.RandGenerator, nat_fields_mask_arg uint32) {
	...
	BuiltinDictStringStringFillRandom(rg, &item.Labels)
...
func (item *StatshousePromTarget) ReadTL1(w []byte, nat_fields_mask_arg uint32) (_ []byte, err error) {
	...
	if w, err = BuiltinDictStringStringReadTL1(w, &item.Labels); err != nil {
		return w, err
	}
...
func (item *StatshousePromTarget) WriteTL1(w []byte, nat_fields_mask_arg uint32) []byte {
	w = basictl.NatWrite(w, item.FieldsMask)
	w = basictl.StringWrite(w, item.JobName)
	w = basictl.StringWrite(w, item.Url)
	w = BuiltinDictStringStringWriteTL1(w, item.Labels)
...
func (item *StatshousePromTarget) ReadTL1Boxed(w []byte, nat_fields_mask_arg uint32) (_ []byte, err error) {
	if w, err = basictl.NatReadExactTag(w, 0xac5296df); err != nil {
		return w, err
	}
	return item.ReadTL1(w, nat_fields_mask_arg)
}

func (item *StatshousePromTarget) WriteTL1Boxed(w []byte, nat_fields_mask_arg uint32) []byte {
...
func (item *StatshousePromTarget) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer, nat_fields_mask_arg uint32) error {
	...
	var propHonorTimestampsPresented bool
	var trueTypeHonorTimestampsValue bool
	var propHonorLabelsPresented bool
	...
	if propMetricRelabelConfigsPresented {
		if nat_fields_mask_arg&(1<<1) == 0 {
			return ErrorInvalidJSON("statshouse.promTarget", "field 'metric_relabel_configs' is set, but will be ignored, because corresponding fieldmask nat_fields_mask_arg bit 1 is 0")
		}
	}
	if propHonorTimestampsPresented && !trueTypeHonorTimestampsValue && (item.FieldsMask&(1<<0) != 0) {
		return ErrorInvalidJSON("statshouse.promTarget", "field 'honor_timestamps' is explicitly set to false, but corresponding fieldmask item.FieldsMask bit 0 is 1")
	}
	if propHonorLabelsPresented && !trueTypeHonorLabelsValue && (item.FieldsMask&(1<<1) != 0) {
		return ErrorInvalidJSON("statshouse.promTarget", "field 'honor_labels' is explicitly set to false, but corresponding fieldmask item.FieldsMask bit 1 is 1")
	}
	return nil
}
...
type StatshousePromTargetBytes struct {
	...
	JobName        []byte
	Url            []byte
	Labels         []DictFieldStringStringBytes
	ScrapeInterval int64
	// HonorTimestamps (TrueType) // Conditional: item.FieldsMask.0
	// HonorLabels (TrueType) // Conditional: item.FieldsMask.1
	ScrapeTimeout         int64
...
func (item *StatshousePromTargetBytes) FillRandom(rg *basictl.RandGenerator, nat_fields_mask_arg uint32) {
	...
	BuiltinDictStringStringBytesFillRandom(rg, &item.Labels)
	item.ScrapeInterval = basictl.RandomLong(rg)
	item.ScrapeTimeout = basictl.RandomLong(rg)
	item.BodySizeLimit = basictl.RandomLong(rg)
	item.LabelLimit = basictl.RandomLong(rg)
...
func (item *StatshousePromTargetBytes) ReadTL1(w []byte, nat_fields_mask_arg uint32) (_ []byte, err error) {
	if w, err = basictl.NatRead(w, &item.FieldsMask); err != nil {
		return w, err
	}
	...
	if w, err = BuiltinDictStringStringBytesReadTL1(w, &item.Labels); err != nil {
		return w, err
	}
	if w, err = basictl.LongRead(w, &item.ScrapeInterval); err != nil {
		return w, err
...
func (item *StatshousePromTargetBytes) WriteTL1(w []byte, nat_fields_mask_arg uint32) []byte {
	w = basictl.NatWrite(w, item.FieldsMask)
	w = basictl.StringWriteBytes(w, item.JobName)
	w = basictl.StringWriteBytes(w, item.Url)
	w = BuiltinDictStringStringBytesWriteTL1(w, item.Labels)
	w = basictl.LongWrite(w, item.ScrapeInterval)
	w = basictl.LongWrite(w, item.ScrapeTimeout)
	w = basictl.LongWrite(w, item.BodySizeLimit)
	w = basictl.LongWrite(w, item.LabelLimit)
...
func (item *StatshousePromTargetBytes) ReadTL1Boxed(w []byte, nat_fields_mask_arg uint32) (_ []byte, err error) {
	if w, err = basictl.NatReadExactTag(w, 0xac5296df); err != nil {
		return w, err
	}
	return item.ReadTL1(w, nat_fields_mask_arg)
...
func (item *StatshousePromTargetBytes) WriteTL1Boxed(w []byte, nat_fields_mask_arg uint32) []byte {
	w = basictl.NatWrite(w, 0xac5296df)
	return item.WriteTL1(w, nat_fields_mask_arg)
}
