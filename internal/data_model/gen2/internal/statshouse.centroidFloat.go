...
func BuiltinVectorStatshouseCentroidFloatReadTL1(w []byte, vec *[]StatshouseCentroidFloat) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorStatshouseCentroidFloatWriteTL1(w []byte, vec []StatshouseCentroidFloat) []byte {
...
func BuiltinVectorStatshouseCentroidFloatInternalReadTL2(r []byte, vec *[]StatshouseCentroidFloat) (_ []byte, err error) {
...
func (item *StatshouseCentroidFloat) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *StatshouseCentroidFloat) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseCentroidFloat) WriteTL1(w []byte) []byte {
	w = basictl.FloatWrite(w, item.Value)
	w = basictl.FloatWrite(w, item.Count)
	return w
}

func (item *StatshouseCentroidFloat) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseCentroidFloat) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseCentroidFloat) WriteTL1Boxed(w []byte) []byte {
