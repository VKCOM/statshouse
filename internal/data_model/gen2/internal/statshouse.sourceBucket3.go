...
func (item *StatshouseSourceBucket3) Write(w []byte) []byte {
...
func (item *StatshouseSourceBucket3) ReadBoxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseSourceBucket3) WriteBoxed(w []byte) []byte {
...
func (item *StatshouseSourceBucket3Bytes) Write(w []byte) []byte {
	w = basictl.NatWrite(w, item.FieldsMask)
...
func (item *StatshouseSourceBucket3Bytes) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = basictl.NatReadExactTag(w, 0x16c4dd7b); err != nil {
		return w, err
	}
	return item.Read(w)
...
func (item *StatshouseSourceBucket3Bytes) WriteBoxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x16c4dd7b)
	return item.Write(w)
}
