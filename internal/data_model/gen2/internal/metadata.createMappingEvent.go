...
func (item *MetadataCreateMappingEvent) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *MetadataCreateMappingEvent) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *MetadataCreateMappingEvent) WriteTL1(w []byte) []byte {
...
func (item *MetadataCreateMappingEvent) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *MetadataCreateMappingEvent) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *MetadataCreateMappingEvent) WriteTL1Boxed(w []byte) []byte {
...
func (item *MetadataCreateMappingEvent) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	if propCreatePresented && !trueTypeCreateValue && (item.FieldMask&(1<<0) != 0) {
		return ErrorInvalidJSON("metadata.createMappingEvent", "field 'create' is explicitly set to false, but corresponding fieldmask item.FieldMask bit 0 is 1")
	}
	return nil
}

// This method is general version of WriteJSON, use it instead!
func (item *MetadataCreateMappingEvent) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *MetadataCreateMappingEvent) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *MetadataCreateMappingEvent) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	panic(ErrorTL2SerializersNotGenerated("metadata.createMappingEvent"))
}

func (item *MetadataCreateMappingEvent) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	return r, ErrorTL2SerializersNotGenerated("metadata.createMappingEvent")
}
