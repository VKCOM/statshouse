...
func BuiltinVectorStatshouseApiPointMetaRepairMasks(vec *[]StatshouseApiPointMeta) {
	for i := range *vec {
		(*vec)[i].RepairMasks()
	}
}
func BuiltinVectorStatshouseApiPointMetaReadTL1(w []byte, vec *[]StatshouseApiPointMeta) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorStatshouseApiPointMetaWriteTL1(w []byte, vec []StatshouseApiPointMeta) []byte {
...
func (item StatshouseApiPointMeta) RepairMasksValue() StatshouseApiPointMeta {
	item.RepairMasks()
	return item
}
func (item *StatshouseApiPointMeta) RepairMasks() {
	item.tl2mask0 = 0
	if item.FieldsMask&(1<<1) != 0 {
		item.tl2mask0 |= 1
	}
...
func (item *StatshouseApiPointMeta) ReadTL1(w []byte) (_ []byte, err error) {
	item.tl2mask0 = 0
...
func (item *StatshouseApiPointMeta) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *StatshouseApiPointMeta) WriteTL1(w []byte) []byte {
...
func (item *StatshouseApiPointMeta) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *StatshouseApiPointMeta) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *StatshouseApiPointMeta) WriteTL1Boxed(w []byte) []byte {
