...
func (item *MetadataPutMapping) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *MetadataPutMappingResponse) error {
...
func (item *MetadataPutMapping) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret MetadataPutMappingResponse) (_ []byte, err error) {
...
func (item *MetadataPutMapping) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret MetadataPutMappingResponse
...
func (item *MetadataPutMapping) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret MetadataPutMappingResponse
...
func (item *MetadataPutMapping) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("metadata.putMapping")
}
...
func (item *MetadataPutMapping) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *MetadataPutMapping) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *MetadataPutMapping) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *MetadataPutMapping) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	panic(ErrorTL2SerializersNotGenerated("metadata.putMapping"))
}

func (item *MetadataPutMapping) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
