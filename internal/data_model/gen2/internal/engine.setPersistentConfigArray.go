...
func (item *EngineSetPersistentConfigArray) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *EngineSetPersistentConfigArray) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *EngineSetPersistentConfigArray) WriteTL1(w []byte) []byte {
	w = basictl.StringWrite(w, item.Name)
	w = BuiltinVectorIntWriteTL1(w, item.Values)
	return w
}

func (item *EngineSetPersistentConfigArray) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *EngineSetPersistentConfigArray) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *EngineSetPersistentConfigArray) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0xfc99af0b)
	return item.WriteTL1(w)
}

func (item *EngineSetPersistentConfigArray) ReadResultTL1(w []byte, ret *True) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *EngineSetPersistentConfigArray) WriteResultTL1(w []byte, ret True) (_ []byte, err error) {
...
func (item *EngineSetPersistentConfigArray) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret True
	ret.FillRandom(rg)
...
func (item *EngineSetPersistentConfigArray) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.setPersistentConfigArray")
}

func (item *EngineSetPersistentConfigArray) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("engine.setPersistentConfigArray")
}
