...
func (item *MetadataGetEntity) FillRandomResult(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret MetadataEvent
	ret.FillRandom(rg)
	return item.WriteResult(w, ret)
}

func (item *MetadataGetEntity) ReadResultWriteResultJSON(tctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret MetadataEvent
...
func (item *MetadataGetEntity) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret MetadataEvent
...
func (item *MetadataGetEntity) ReadResultWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("metadata.getEntity")
}

func (item *MetadataGetEntity) ReadResultTL2WriteResult(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	return r, w, ErrorTL2SerializersNotGenerated("metadata.getEntity")
}
