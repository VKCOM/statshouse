...
func BuiltinVectorMetadataHistoryShortResponseEventReadTL1(w []byte, vec *[]MetadataHistoryShortResponseEvent, nat_t uint32) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorMetadataHistoryShortResponseEventWriteTL1(w []byte, vec []MetadataHistoryShortResponseEvent, nat_t uint32) []byte {
...
func (item *MetadataHistoryShortResponseEvent) ReadTL1(w []byte, nat_field_mask uint32) (_ []byte, err error) {
...
func (item *MetadataHistoryShortResponseEvent) WriteTL1(w []byte, nat_field_mask uint32) []byte {
	w = basictl.LongWrite(w, item.Version)
	w = basictl.StringWrite(w, item.Metadata)
	return w
}

func (item *MetadataHistoryShortResponseEvent) ReadTL1Boxed(w []byte, nat_field_mask uint32) (_ []byte, err error) {
...
func (item *MetadataHistoryShortResponseEvent) WriteTL1Boxed(w []byte, nat_field_mask uint32) []byte {
