...
'err_*_utf8'' statuses store original string value in hex.`,
	...
	Tags: []MetricMetaTag{{
		...
		ValueComments: convertToValueComments(map[int32]string{
			...
			TagValueIDSrcIngestionStatusWarnTimestampClampedFutureAgg: "warn_timestamp_clamped_future_agg",
...
var BuiltinMetricMetaSrcReceivedSampleBudget = &MetricMetaValue{
	Name:                    "__src_received_sample_budget",
	Kind:                    MetricKindValue,
	Description:             `Sample budget sent to agent in SendSourceBucket3 response. Set by aggregator.`,
	NoSampleAgent:           true, // TODO: prove if necessary
	BuiltinAllowedToReceive: false,
	WithAgentEnvRouteArch:   true,
	WithAggregatorID:        true,
	Tags: []MetricMetaTag{{
		Description: "agent_host",
	}},
	ShardStrategy: ShardFixed, // always sharded to the zero shard
	ShardNum:      0,
}

var BuiltinMetricMetaSrcAgentSampleFactor = &MetricMetaValue{
	Name:                    "__src_agent_sample_factor",
	Kind:                    MetricKindValue,
	Description:             `Smoothed source-side sample factor signal per agent host. Set by aggregator.`,
	NoSampleAgent:           true, // TODO: prove if necessary
	BuiltinAllowedToReceive: false,
	WithAgentEnvRouteArch:   true,
	WithAggregatorID:        true,
...
var BuiltinMetricMetaAggAgentSampleFactor = &MetricMetaValue{
	Name:                    "__agg_agent_sample_factor",
	Kind:                    MetricKindValue,
	Description:             `Smoothed aggregator-side sample factor signal per agent host. Set by aggregator.`,
	NoSampleAgent:           true, // TODO: prove if necessary
	BuiltinAllowedToReceive: false,
	WithAgentEnvRouteArch:   true,
	WithAggregatorID:        true,
