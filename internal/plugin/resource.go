...
var (
	availableFunctions = map[string][]string{
		format.MetricKindCounter: {
			model.ParamQueryFnCountNorm,
			model.ParamQueryFnCount,
			model.ParamQueryFnCumulCount,
			model.ParamQueryFnMaxCountHost,
			model.ParamQueryFnDerivativeCount,
			model.ParamQueryFnDerivativeCountNorm,
		},
		format.MetricKindValue: {
			model.ParamQueryFnAvg,
			model.ParamQueryFnMin,
			model.ParamQueryFnMax,
			model.ParamQueryFnSumNorm,
			model.ParamQueryFnSum,
			model.ParamQueryFnStddev,
			model.ParamQueryFnCountNorm,
			model.ParamQueryFnCount,
			model.ParamQueryFnCumulAvg,
			model.ParamQueryFnCumulSum,
			model.ParamQueryFnCumulCount,
			model.ParamQueryFnMaxHost,
			model.ParamQueryFnDerivativeCount,
			model.ParamQueryFnDerivativeCountNorm,
			model.ParamQueryFnDerivativeSum,
			model.ParamQueryFnDerivativeSumNorm,
			model.ParamQueryFnDerivativeAvg,
			model.ParamQueryFnDerivativeMin,
			model.ParamQueryFnDerivativeMax,
		},
		format.MetricKindValuePercentiles: {
			...
			model.ParamQueryFnCumulSum,
			model.ParamQueryFnCumulCount,
			model.ParamQueryFnP25,
			model.ParamQueryFnP50,
			model.ParamQueryFnP75,
			model.ParamQueryFnP90,
			model.ParamQueryFnP95,
			model.ParamQueryFnP99,
			model.ParamQueryFnP999,
			model.ParamQueryFnMaxHost,
			model.ParamQueryFnDerivativeCount,
			model.ParamQueryFnDerivativeCountNorm,
			model.ParamQueryFnDerivativeSum,
		...
		format.MetricKindUnique: {
			model.ParamQueryFnUniqueNorm,
			model.ParamQueryFnUnique,
			model.ParamQueryFnCountNorm,
			model.ParamQueryFnCount,
			model.ParamQueryFnCumulCount,
			model.ParamQueryFnAvg,
			...
			model.ParamQueryFnDerivativeMin,
			model.ParamQueryFnDerivativeMax,
			model.ParamQueryFnDerivativeUnique,
			model.ParamQueryFnDerivativeUniqueNorm,
		},
