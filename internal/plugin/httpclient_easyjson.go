...
func easyjsonB4ad7d41DecodeGithubComVkcomStatshouseInternalPlugin(in *jlexer.Lexer, out *GetQueryResponse) {
...
func easyjsonB4ad7d41EncodeGithubComVkcomStatshouseInternalPlugin(out *jwriter.Writer, in GetQueryResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v GetQueryResponse) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonB4ad7d41EncodeGithubComVkcomStatshouseInternalPlugin(w, v)
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetQueryResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB4ad7d41DecodeGithubComVkcomStatshouseInternalPlugin(l, v)
}
		...
		case "series_meta":
			if in.IsNull() {
				...
				if out.SeriesMeta == nil {
					if !in.IsDelim(']') {
						out.SeriesMeta = make([]api.QuerySeriesMetaV2, 0, 0)
					} else {
				...
				for !in.IsDelim(']') {
					...
					easyjsonB4ad7d41DecodeGithubComVkcomStatshouseInternalApi(in, &v2)
	...
	}
	{
		...
		if in.SeriesMeta == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v7, v8 := range in.SeriesMeta {
				...
				easyjsonB4ad7d41EncodeGithubComVkcomStatshouseInternalApi(out, v8)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonB4ad7d41DecodeGithubComVkcomStatshouseInternalApi(in *jlexer.Lexer, out *api.QuerySeriesMetaV2) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "tags":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					easyjsonB4ad7d41DecodeGithubComVkcomStatshouseInternalApi1(in, &v13)
					(out.Tags)[key] = v13
					in.WantComma()
				}
				in.Delim('}')
...
func easyjsonB4ad7d41EncodeGithubComVkcomStatshouseInternalApi(out *jwriter.Writer, in api.QuerySeriesMetaV2) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Tags == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			for v15Name, v15Value := range in.Tags {
				...
				out.RawByte(':')
				easyjsonB4ad7d41EncodeGithubComVkcomStatshouseInternalApi1(out, v15Value)
			}
			out.RawByte('}')
		}
	}
...
func easyjsonB4ad7d41DecodeGithubComVkcomStatshouseInternalApi1(in *jlexer.Lexer, out *api.SeriesMetaTag) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB4ad7d41EncodeGithubComVkcomStatshouseInternalApi1(out *jwriter.Writer, in api.SeriesMetaTag) {
	out.RawByte('{')
	first := true
	_ = first
	{
