...
func Test_NAN_Is_Null(t *testing.T) {
	...
	t.Run("SeriesResponse", func(t *testing.T) {
		...
		r.MarshalEasyJSON(&jw)
		b, _ := jw.BuildBytes(nil)
		require.Equal(t, `{"series":{"time":null,"series_meta":null,"series_data":[[null,0]]},"receive_errors_legacy":0,"sampling_factor_src":0,"sampling_factor_agg":0,"mapping_flood_events_legacy":0,"receive_errors":0,"receive_warnings":0,"mapping_errors":0,"promql":"","__debug_queries":null,"promqltestfailed":false,"excess_point_left":false,"excess_point_right":false,"metric":null}`, string(b))
	})
