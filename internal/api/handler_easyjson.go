	...
	for !in.IsDelim('}') {
		...
		case "tags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v29 format.MetricMetaTag
					easyjson888c126aDecodeGithubComVkcomStatshouseInternalFormat2(in, &v29)
	...
	if len(in.Tags) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v30, v31 := range in.Tags {
				...
				easyjson888c126aEncodeGithubComVkcomStatshouseInternalFormat2(out, v31)
			}
			out.RawByte(']')
		}
	}
...
func easyjson888c126aEncodeGithubComVkcomStatshouseInternalFormat2(out *jwriter.Writer, in format.MetricMetaTag) {
	...
	if len(in.ID2Value) != 0 {
		...
		}
		{
			out.RawByte('{')
			v34First := true
			for v34Name, v34Value := range in.ID2Value {
				if v34First {
					v34First = false
				} else {
					out.RawByte(',')
				}
				out.Int32Str(int32(v34Name))
				out.RawByte(':')
	...
	if len(in.ValueComments) != 0 {
		...
		}
		{
			out.RawByte('{')
			v35First := true
			for v35Name, v35Value := range in.ValueComments {
				if v35First {
					v35First = false
				} else {
					out.RawByte(',')
...
func easyjson888c126aEncodeGithubComVkcomStatshouseInternalApi12(out *jwriter.Writer, in GetMetricTagValuesResp) {
	...
	_ = first
	{
		...
		if in.TagValues == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v60, v61 := range in.TagValues {
				if v60 > 0 {
					out.RawByte(',')
				}
...
func easyjson888c126aEncodeGithubComVkcomStatshouseInternalApi16(out *jwriter.Writer, in GetDashboardListResp) {
	...
	_ = first
	{
		...
		if in.Dashboards == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v66, v67 := range in.Dashboards {
				if v66 > 0 {
					out.RawByte(',')
				}
...
func easyjson888c126aEncodeGithubComVkcomStatshouseInternalApi19(out *jwriter.Writer, in DashboardMetaInfo) {
	...
	}
	{
		...
		if in.JSONData == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v69First := true
			for v69Name, v69Value := range in.JSONData {
				if v69First {
					v69First = false
				} else {
					out.RawByte(',')
