...
Поэтому в StatsHouse для всех метрик включен очень дешёвый интересный механизм, когда в специальную колонку max_host при агрегации
...
TODO - ответить ошибкой для упрощение отладки клиентских библиотек.
