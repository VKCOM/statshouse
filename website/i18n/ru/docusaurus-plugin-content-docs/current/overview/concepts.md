...
* [агрегацией](#агрегация),
* [кардинальностью](#кардинальность),
* [семплированием](#семплирование).
...
(см. [минимальный интервал агрегации из доступных](#минимальный-интервал-агрегации-из-доступных)).
:::
...
[семплирование](#семплирование), [уменьшите разрешение метрики](../guides/edit-metrics.md#resolution).
