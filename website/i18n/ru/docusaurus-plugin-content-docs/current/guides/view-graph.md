...
Чтобы поместить часто используемую метрику в список избранного, нажмите на "звёздочку" рядом с названием метрики:

<img src={FavoriteMetrics} width="300"/>

Чтобы отображались только метрики из списка избранного, нажмите на "закладку со звёздочкой":

<img src={FavoriteMetricsOnly} width="300"/>

Дашборды тоже можно [помещать в список избранного](./dashboards.md#избранные-дашборды).
...
Чтобы добавить или изменить описание графика, нажмите на "карандашик" рядом с его названием.
