...
../target/statshouse-agg --auto-create --auto-create-default-namespace --agg-addr=127.0.0.1:13336,127.0.0.1:13346,127.0.0.1:13356 --local-replica=3 --local-shard=1 \
