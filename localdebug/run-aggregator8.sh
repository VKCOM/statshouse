...
../target/statshouse-agg --auto-create --auto-create-default-namespace --agg-addr=127.0.0.1:13396,127.0.0.1:13406,127.0.0.1:13416 --previous-shards=6 --local-replica=2 --local-shard=3 \
