...
$AGGREGATOR aggregator --cluster=default --log-level=trace --agg-addr=':13336' --kh=127.0.0.1:8123 \
  --auto-create -cache-dir=/var/lib/statshouse/cache/aggregator -u=root -g=root &
$AGENT agent --cluster=default --log-level=trace --remote-write-enabled \
