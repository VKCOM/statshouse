-- TL;DR
-- v4_1s, v4_1m, v4_1h
-- v4_1s_dist, v4_1m_dist, v4_1h_dist
-- v4_1s_matview, v4_1m_matview, v4_1h_matview
--
--
-- SETTINGS
-- v4_1s:
...
-- tables
-- 1s
CREATE TABLE IF NOT EXISTS statshouse_v4_1s ON CLUSTER statlogs2
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
    `pre_stag` String,
    `time_coarse` DateTime,
    `tag0` Int32,
    `stag0` String,
    `tag1` Int32,
    `stag1` String,
...
-- 1m
CREATE TABLE IF NOT EXISTS statshouse_v4_1m ON CLUSTER statlogs2
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
...
-- 1h
CREATE TABLE IF NOT EXISTS statshouse_v4_1h ON CLUSTER statlogs2
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
...
-- dist tables
-- 1s
CREATE TABLE IF NOT EXISTS statshouse_v4_1s_dist ON CLUSTER statlogs2
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
    ...
    ENGINE = Distributed('statlogs2', 'default', 'statshouse_v4_1s')
;


-- 1m
CREATE TABLE IF NOT EXISTS statshouse_v4_1m_dist ON CLUSTER statlogs2
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
    ...
    ENGINE = Distributed('statlogs2', 'default', 'statshouse_v4_1m')
;


-- 1h
CREATE TABLE IF NOT EXISTS statshouse_v4_1h_dist ON CLUSTER statlogs2
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
    ...
    ENGINE = Distributed('statlogs2', 'default', 'statshouse_v4_1h')
;
...
-- matviews
-- 1s
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_v4_1s_matview TO statshouse_v4_1s
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
...
AS SELECT
              ...
              `pre_tag`,
              `pre_stag`,
              toStartOfMinute(`time`) as `time_coarse`,
              `tag0`,
              `stag0`,
              `tag1`,
              `stag1`,
...
-- 1m
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_v4_1m_matview TO statshouse_v4_1m
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
...
AS SELECT
              ...
              `pre_tag`,
              `pre_stag`,
              toStartOfHour(`time`) as `time_coarse`,
              `tag0`,
              `stag0`,
              `tag1`,
              `stag1`,
...
-- 1h
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_v4_1h_matview TO statshouse_v4_1h
(
    `index_type` UInt8,
    `metric` Int32,
    `pre_tag` UInt32,
...
AS SELECT
              ...
              `pre_tag`,
              `pre_stag`,
              fromUnixTimestamp(intDiv(toUInt32(`time`), 86400) * 86400) as `time_coarse`,
              `tag0`,
              `stag0`,
              `tag1`,
              `stag1`,
