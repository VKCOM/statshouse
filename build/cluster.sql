...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_contributors_log_agg ON CLUSTER statlogs2 TO statshouse_contributors_log_buffer 
(`insert_time` DateTime,
 `time` DateTime,
 `count` SimpleAggregateFunction(sum, Float64))
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_contributors_log_agg2 ON CLUSTER statlogs2 TO statshouse_contributors_log_buffer 
(`insert_time` DateTime,
 `time` DateTime,
 `count` SimpleAggregateFunction(sum, Float64))
AS SELECT now() AS insert_time, time, count
...
(`insert_time` DateTime,
 `time` DateTime,
 `count` SimpleAggregateFunction(sum, Float64))
ENGINE = Distributed('statlogs2', 'default', 'statshouse_contributors_log');
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_metric_1d_agg ON CLUSTER statlogs2 TO statshouse_metric_1d_buffer 
(`metric` Int32,
 `time` DateTime,
 `row_count` UInt8,
 `count` SimpleAggregateFunction(sum, Float64))
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_metric_1d_agg2 ON CLUSTER statlogs2 TO statshouse_metric_1d_buffer 
(`metric` Int32,
 `time` DateTime,
 `row_count` UInt8,
 `count` SimpleAggregateFunction(sum, Float64))
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_metric_1d_agg2_move ON CLUSTER statlogs2 TO statshouse_metric_1d_buffer 
(`metric` Int32,
 `time` DateTime,
 `row_count` UInt8,
 `count` SimpleAggregateFunction(sum, Float64))
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1h_agg ON CLUSTER statlogs2 TO statshouse_value_1h 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1h_agg2 ON CLUSTER statlogs2 TO statshouse_value_1h 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1h_agg2_move ON CLUSTER statlogs2 TO statshouse_value_1h 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1h_agg_prekey ON CLUSTER statlogs2 TO statshouse_value_1h_prekey 
(`metric` Int32,
 `prekey` Int32,
 `prekey_set` UInt8,
 `time` DateTime,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1h_agg_prekey_move ON CLUSTER statlogs2 TO statshouse_value_1h_prekey 
(`metric` Int32,
 `prekey` Int32,
 `prekey_set` UInt8,
 `time` DateTime,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1m_agg ON CLUSTER statlogs2 TO statshouse_value_1m 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1m_agg2 ON CLUSTER statlogs2 TO statshouse_value_1m 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1m_agg2_move ON CLUSTER statlogs2 TO statshouse_value_1m 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1m_agg_prekey ON CLUSTER statlogs2 TO statshouse_value_1m_prekey 
(`metric` Int32,
 `prekey` Int32,
 `prekey_set` UInt8,
 `time` DateTime,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1m_agg_prekey_move ON CLUSTER statlogs2 TO statshouse_value_1m_prekey 
(`metric` Int32,
 `prekey` Int32,
 `prekey_set` UInt8,
 `time` DateTime,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1s_agg ON CLUSTER statlogs2 TO statshouse_value_1s 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1s_agg2 ON CLUSTER statlogs2 TO statshouse_value_1s 
(`metric` Int32,
 `time` DateTime,
 `key0` Int32,
 `key1` Int32,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS statshouse_value_1s_agg_prekey ON CLUSTER statlogs2 TO statshouse_value_1s_prekey 
(`metric` Int32,
 `prekey` Int32,
 `prekey_set` UInt8,
 `time` DateTime,
