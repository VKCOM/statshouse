...
describe('plotQueryParams', () => {
  ...
  test('writeParams', () => {
    ...
    expect(params.toString()).toEqual(
      'other=param&tn=-1&f=-172800&t=1660038496&s=api_methods&qb=key1&qf=key1-messages&qf=key1-stats&qf=key2%7EgetById&qf=key2%7EgetLongPollServer&qf=key2%7EgetSuggestedContacts&yl=118794&yh=140183&t1.s=api_methods&t1.qw=min&t1.qb=key1&t1.qf=key0-production&t1.qf=key2-add&t1.qf=key2-getById&t1.yl=50&t1.yh=169&t2.s=api_methods&t2.qw=p90&t2.g=1&t2.qf=key0-production&t2.qf=key2-add&t2.qf=key2-trackEvents&t2.n=10&t2.ts=-86400&t2.yl=131&t2.yh=161'
    );
  });
