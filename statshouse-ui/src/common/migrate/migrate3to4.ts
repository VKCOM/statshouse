  ...
  return (params) => {
    ...
    plotKeys.forEach((plotKey) => {
      if (params.plots[plotKey]) {
        ...
        // let w: number = LAYOUT_WIDGET_SIZE[params.plots[plotKey].type].minW ?? 1;
        //
        // switch (size) {
        //   case '1':
        //     w = LAYOUT_COLUMNS;
        ...
        //     break;
        // }
        // const h = Math.max(w, LAYOUT_WIDGET_SIZE[params.plots[plotKey].type].minH ?? 1);

        // if (col + w > LAYOUT_COLUMNS) {
        //   col = 0;
        //   row += h;
        // }
        // params.plots[plotKey].layout = {
        //   x: col,
        //   y: row,
        //   w: w,
        //   h: h,
